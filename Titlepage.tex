...
\newcommand*{\titlePageTUWienPhysik}{
	...
	\begin{tabular}{ >{\centering}p{9cm} >{\centering}p{7cm} }
		\space & {\line(1,0){120}\\signature supervisor}
	\end{tabular}
	...
	\begin{figure}[h]
		\centering
			...
			{\includegraphics[width=0.5\textwidth]{Figures/TU_Wien_Logo.png}}
	...
	\vspace{\stretch{1.8}}
	\begin{large}
	at the \cmdKV@AbschlussarbeitTUWienPhysikTitlePage@institut \\
	...
	\centering
	\today & \line(1,0){120}\\signature student
	\end{tabular}
	\end{large}
